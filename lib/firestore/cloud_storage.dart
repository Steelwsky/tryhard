...
typedef SaveGymnastics = Future<void> Function(
    {required Gymnastics gymnastics, required String? userGuid});

typedef SaveWorkout = Future<void> Function(
    {required Workout workout, required String? userGuid});

typedef PersistUser = Future<void> Function({required User? user});

typedef LoadUserWorkouts = Future<List<Workout>> Function(
