...
void main() {
  group('UserController, log in function', () {
    test('retrieving user from login provider, error', () async {
      final FakeLoginProviderError fakeLoginProviderError = FakeLoginProviderError();
    ...
    test('retrieving user from login provider, successful', () async {
      final FakeLoginProviderSuccessful fakeLoginProviderSuccess = FakeLoginProviderSuccessful();
